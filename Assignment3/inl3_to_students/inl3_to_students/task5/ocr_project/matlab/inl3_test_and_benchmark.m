...
% mysystem.classifier = 'CNN_classify'; % What is the name of your classification-algorithm?
 mysystem.classifier = 'SVM_classify';
% mysystem.classifier = 'KNN_classify';
%mysystem.classifier = 'BP_classify';
