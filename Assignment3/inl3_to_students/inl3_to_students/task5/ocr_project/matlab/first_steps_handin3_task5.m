...
% S_feats = zeros(29, 100); % 7, since I use 7 features -- change appropriately!
%S_feats = zeros(1181, 100); % 7, since I use 7 features -- change appropriately!
S_feats = zeros(10, 100);
%S_feats = zeros(1152, 100);
for i = 1 : numel(S)
...
%  classification_data = CNN_train(S_feats, y);
 classification_data = SVM_train(S_feats, y);
 
% classification_data = KNN_train(S_feats, y);
 % classification_data = BP_train(S_feats, y);
