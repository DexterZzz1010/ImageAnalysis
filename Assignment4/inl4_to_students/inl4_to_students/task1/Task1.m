...
grayWorldImage(:,:,1) = grayWorldImage(:,:,1) * 0.5 / meanR;
grayWorldImage(:,:,2) = grayWorldImage(:,:,2) * 0.5 / meanG;
grayWorldImage(:,:,3) = grayWorldImage(:,:,3) * 0.5 / meanB;
